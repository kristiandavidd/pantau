export default function Problems() {
    return(
        <div className="mb-20">
            <h1 className="px-5 mb-8 text-2xl font-bold text-center">Say Goodbye to Uncertainty in Your Fields</h1>
            <div className="flex flex-col m-auto md:flex-row md:w-2/3">
